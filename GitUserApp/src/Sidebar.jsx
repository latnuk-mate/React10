    ...
    <div className="border p-3 shadow-sm shadow-slate-300 rounded-sm text-center max-h-[400px] md:max-h-[350px] ">
      ...
      {profile && (
        ...
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
          ...
          {profile.location}</h5>
        <a href={profile.url} className="text-lg underline">Visit Profile</a>
        <a href={profile.blog} className="text-lg underline mt-2 flex items-center justify-center gap-2">
