export default function({moviedata, setMovieData, filterMovie}){
    ...
    function removeMovie(name){
        ...
        const data = moviedata.filter(item => item.name !== name);
    ...
    return (
        <>
            {
                (filterMovie.length == 0) && (<div className="text-zinc-100 text-xl text-center mt-10">No Movies Available...</div>)
            }
        ...
        <div className="flex items-center justify-between">
            ...
            <svg  onClick={() => removeMovie(movie.name)}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 text-red-500 cursor-pointer">
