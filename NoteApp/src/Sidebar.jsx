  ...
  return (
    ...
    notes && notes.map((note, index) => (
      ...
      `${note.noteId === currentNote.noteId ? 
        ...
        ""}`}
          key={note.noteId}
        onClick={() => setCurrentId(note.noteId)}>
           Notes {index + 1}
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16" onClick={deleteNote}>
