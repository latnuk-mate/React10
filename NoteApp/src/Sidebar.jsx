    ...
    notes && notes.map((note) => (
      ...
      `${note.id === currentNote.id ? 
        ...
        onClick={() => setCurrentId(note.id)}>
           {note.body.split("\n")[0]}
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-trash3 absolute right-4 top-2" viewBox="0 0 16 16" onClick={deleteNote}>
